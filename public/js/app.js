...
function initAdmin() {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      return "\n            <p>".concat(menuItem.item.name, " - ").concat(menuItem.qty, " plate </p>\n            ");
    }).join('');
  }
...
function updateCart(momo) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', momo).then(function (res) {
    console.log(res);
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var momo = JSON.parse(btn.dataset.momo);
    updateCart(momo);
  });
});
...
__webpack_require__(/*! C:\Users\sarth\OneDrive\Desktop\momo-palace\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\sarth\OneDrive\Desktop\momo-palace\resources\scss\app.scss */"./resources/scss/app.scss");
